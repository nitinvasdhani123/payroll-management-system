...
function right() {
  ...
  const sendData = async (demp) => {
    try {
      ...
      const response3 = await axios.post('http://localhost:8000/api/project-detail');
        ...
        <div className='cards'>
          <div className="user-profile">
            ...
            <div className="user-details">
              <h3 className="user-name"><u>Name</u></h3>
              <p className="user-email">Mail id</p>
              <p className="user-role">Designation</p>
              <div className="user-bio"><p>User id</p></div>
            </div>
          </div>
